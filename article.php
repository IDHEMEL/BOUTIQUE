...
<div align='center'>
    <div class="container p-3 my-3 bg-dark text-white" uk-grid>
        ...
        <div>
            <div class="container p-3 my-3 bg-dark text-white" align='left'>
                <h3 class="container p-3 my-3 bg-dark text-white"><?= $a['name'] ?></h3>
                <p><?= $a['description'] ?></p>
                <div>
